...
#attaching the time and date to the data files
  ...
  mv testing/projan/normData/testTenNorm master/projan/normData/testTenNorm."$today"  
  
#putting the files in local repo
  cp -Rf $HOME/test* master/projan/data
  cp -Rf $HOME/refBench master/projan
  ...
  cp -Rf TimePlot.png master/projan/figures
  cp -Rf TimePlotTen.png master/projan/figures
